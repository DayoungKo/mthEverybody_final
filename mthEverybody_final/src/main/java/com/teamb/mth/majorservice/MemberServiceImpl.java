...
public class MemberServiceImpl implements MemberService {
	...
	public boolean checkValidJoinId(MemberVO requestMemberVO) 
	{
		...
		if (unvalidMemberData != null) { return false; }
	...
	//member_emial로 회원정보 불러오기
	@Override
	public MemberVO getMemberVOByEmail(String member_email)
	{
		MemberVO requestMemberVO = new MemberVO();
		requestMemberVO.setMember_email(member_email);
	...
	// 일반회원 정보 수정 처리
	@Override
	public void updateMemberInfo(MemberVO requestMemberVO) {
		memberSQLMapper.updateForCustomerInfo(requestMemberVO);
	}
	
	//회원 이메일 수정 처리
	@Override
	public void updateMemberEmail(MemberVO requestMemberVO) 
	{
		memberSQLMapper.updateEmail(requestMemberVO);
	}
	...
	@Override
	public String checkMemberCompanynum(String member_companynum) 
	{
