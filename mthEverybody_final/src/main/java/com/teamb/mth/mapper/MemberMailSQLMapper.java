...
public interface MemberMailSQLMapper 
{
	...
	public void updateCertifyCheckForY(String member_idx);
	
	@Update("UPDATE MTH_MEMBER_MAIL SET CERTIFY_CHECK='N', DUEDATE=SYSDATE+1 WHERE MEMBER_IDX=#{member_idx}")
	public void updateCertifyCheckForN(String member_idx);
