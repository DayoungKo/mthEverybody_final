...
public interface MemberSQLMapper {
	...
	@Update("UPDATE MTH_MEMBER SET MEMBER_EMAIL=#{member_email} WHERE MEMBER_IDX=#{member_idx}")
	public void updateEmail(MemberVO requestMemberVO);

	@Update("UPDATE MTH_MEMBER SET MEMBER_CODE='REQ_SELLER', MEMBER_NAME=#{member_name},"
			+ " MEMBER_PHONE=#{member_phone}, MEMBER_COMPANYNUM=#{member_companynum} WHERE MEMBER_IDX=#{member_idx}")
	...
	@Update("UPDATE MTH_MEMBER SET MEMBER_ID=(select MEMBER_ID||#{addStrAtId} FROM MTH_MEMBER WHERE MEMBER_IDX=#{requestMemberVO.member_idx}),"
			+ "MEMBER_EMAIL=(select MEMBER_EMAIL||#{addStrAtId} FROM MTH_MEMBER WHERE MEMBER_IDX=#{requestMemberVO.member_idx}),"
			+ "MEMBER_CODE='DEL_MEMBER' WHERE MEMBER_IDX=#{requestMemberVO.member_idx}")
