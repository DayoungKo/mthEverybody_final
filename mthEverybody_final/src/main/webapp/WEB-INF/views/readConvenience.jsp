...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/checkReplyBytes.js"></script>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/css/conProductInfoReply.css">
...
function likeItem(item_idx) { //좋아요 ajax 로직...
    ...
    {
    	//댓글 내용 공백 체크
    	var inputConvenReContent = document.getElementById('input-ReContent');
    ...
    function updateConvenReContet(conven_re_idx)
    {
		...
		xmlhttp.onreadystatechange = function(){
			...
			if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
			{
				...
				{
					var convenReContentArea = document.getElementById('input-ReContent');
									...
									<form role="form" id="write-ConvenRe-form" method="post">
										...
										<fieldset id='inpup-reply-box'>
											<div class="form-group">
												<textarea id="input-ReContent" name="conven_re_content" class="form-control" rows="3"
												placeholder="Write in your wall" onkeyup="countReplyBytes()" onblur="countReplyBytes()"></textarea>
													<div style="text-align: right;"><span id="view-reply-bytes" style="font-size: 0.9em;">0/300 bytes</span></div>
											</div>
