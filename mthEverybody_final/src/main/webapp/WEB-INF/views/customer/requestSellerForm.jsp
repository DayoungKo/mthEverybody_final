...
<link href="${pageContext.request.contextPath}/resources/css/css/requestsellerform.css" rel="stylesheet">
 ...
 <script src="${pageContext.request.contextPath}/resources/js/requestsellerform.js?after"></script>
			...
			<div id='requestSeller-form-wrap'>
				...
				<form id="requestSellerForm" method="post" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="member_name" id="input-name" required>
                        <div class="view-sys-msg"><p>한글 2자이상 8자이내를 입력해주세요.</p></div>
                    </div>
                    <div class="form-group">
                        <label for="input-phone">전화번호</label>
                        <input type="text" class="form-control" name="member_phone"id="input-phone" required>
                        <div class="view-sys-msg"><p>-를 제외한 번호만 입력해주세요. (ex. 01012345678)</p></div>
                    </div>
                    <div class="form-group">
                        <label for="input-companynum">사업자등록번호</label>
                        <input type="text" class="form-control" name="member_companynum"id="input-companynum" required>
                        <div class="view-sys-msg"><p>-를 제외한 숫자 10자를 입력해주세요.(ex. 0123456789)</p></div>
                    </div>
                     <div class="form-group">
