...
<link href="${pageContext.request.contextPath}/resources/css/main/joinmemberform.css" rel="stylesheet">
 ...
 <script src="${pageContext.request.contextPath}/resources/js/joinmemberForm.js?after"></script>
			...
			<div id='joinmember-form-wrap'>
				<form id="joinMemberForm" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="member_nick" id="input-nick" placeholder="특수문자 제외한 문자 3자이상 12자 이내" onkeyup="checkJoinNick()" onblur="checkJoinNick()">
