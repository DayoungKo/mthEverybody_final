...
<script>
    ...
    {
    	//댓글 내용 공백 체크
    	var inputItemReContent = document.getElementById('input-ReContent');
    ...
    function updateItemReContet(item_re_idx)
    {
		...
		xmlhttp.onreadystatechange = function(){
			...
			if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
			{
				...
				{
					var itemReContentArea = document.getElementById('input-ReContent');
									...
									<form role="form" id="write-itemRe-form" method="post">
										...
										<fieldset id='inpup-reply-box'>
											<div class="form-group">
												<textarea id="input-ReContent" name="item_re_content"
