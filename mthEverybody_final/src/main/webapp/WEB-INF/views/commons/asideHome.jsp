...
<div class="list-group listHome">
        ...
        <c:if test='${sessionLoginedData != null}'>
          ...
          <a href="${pageContext.request.contextPath}/memberMyInfo" class="list-group-item"> <img src="${pageContext.request.contextPath}/resources/img/sidebar/Cake_ChocolateCake_26374.png" alt="">마이 페이지</a>
        </c:if>
